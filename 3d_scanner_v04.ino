...
const int buttonShootPin = 8;             // Shoot camera button

int buttonStartState;                     // Current reading from the input pin
int buttonStartLastState = LOW;           // Previous reading from the input pin
int buttonShootState;                     // Current reading from the input pin
int buttonShootLastState = LOW;           // Previous reading from the input pin
...
const int ledStartPin = 2;                // Number of the LED pin
